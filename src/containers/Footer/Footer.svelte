...
<div class="bg-very-dark-violet text-white">
  <Layout>
    <div
      class="text-center py-12 space-y-12 md:space-y-0 md:flex md:justify-between md:items-start md:gap-8"
    >
      ...
      <div
        class="space-y-8 md:space-y-0 md:flex md:justify-center md:items-start md:gap-12 lg:gap-20 md:text-left"
      >
        <div>
          <h1>Features</h1>
      ...
      <div class="flex justify-center items-center gap-8 md:mt-0">
        <a href="/">
          <svg
            class="fill-current cursor-pointer hover:text-cyan transition-colors duration-300"
            xmlns="http://www.w3.org/2000/svg"
            width="24"
            height="24"
            ><path
